...
export const TextParallaxContentExample = () => {
    return (
        <div className="bg-white">
            <TextParallaxContent
                imgUrl="https://images.unsplash.com/photo-1452700903139-b085a5399ed2?q=80&w=3474&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                subheading="Relive"
                heading="Rugged Adventures"
            >
                {/* <ExampleContent /> */}
            </TextParallaxContent>
            <TextParallaxContent
