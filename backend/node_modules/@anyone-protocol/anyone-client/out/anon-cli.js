...
if (socksPort !== undefined)
    anonConfig.socksPort = socksPort;
const orPort = parsePort(args.values.orPort);
if (orPort !== undefined)
    anonConfig.orPort = orPort;
const controlPort = parsePort(args.values.controlPort);
if (controlPort !== undefined)
    anonConfig.controlPort = controlPort;
const configFile = args.values.config;
if (configFile !== undefined)
    anonConfig.configFile = configFile;
const anon = new anon_1.Anon(anonConfig);
